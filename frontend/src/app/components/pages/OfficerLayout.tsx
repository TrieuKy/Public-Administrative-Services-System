...
import { LayoutDashboard, FileText, BarChart3, Calendar, Settings, Home, LogOut, Shield, Newspaper, LayoutList, Bell, ChevronDown, User, KeyRound, X } from 'lucide-react';
